...
public class FirebaseMethods {
    ...
    public void uploadNewPhoto(String photoType, final String caption,final int count, final String imgUrl, Bitmap bm) {
        ...
        if (photoType.equals(mContext.getString(R.string.new_photo))) {
            ...
            //location where the image stored
            String user_id = FirebaseAuth.getInstance().getCurrentUser().getUid();
            StorageReference storageReference = mStorageReference
                    .child(filePaths.FIREBASE_IMAGE_STORAGE + "/" + user_id + "/photo" + (count + 1));// photo1 photo2 photo3
            ...
            byte[] bytes = ImageManager.getBytesFromBitmap(bm, 100); // in Utils File
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    // getBytesTransferred() = The total number of bytes that have been transferred when this snapshot was taken
    ...
    */
    ...
    private void addPhotoToDatabase(String caption, String url){
        ...
        String tags = StringManipulation.getTags(caption); // in Utils File

        String newPhotoKey = mReference.child(mContext.getString(R.string.dbname_photos)).push().getKey(); // in model File
        ...
        mReference.child(mContext.getString(R.string.dbname_photos)).child(newPhotoKey).setValue(photo);
